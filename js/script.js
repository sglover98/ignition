...
*/	
	...
	if ($(this).width() > 959) {
	    ...
	    $("#progression-studios-header-login-container").hover(function(){
	        if (hidelogin) clearTimeout(hidelogin);
			$("#progression-studios-header-login-container").addClass("helpmeout-activated-class").removeClass("helpmeout-hover-out-class");
	    }, function() {
	        hidelogin = setTimeout(function() { 
				$("#progression-studios-header-login-container").removeClass("helpmeout-activated-class").addClass("helpmeout-hover-out-class");
			}, 100);
	    });
...
/*
=============================================== 10. SHOW/HIDE Project Tabs  ===============================================
*/		

	$('ul.wc-tabs li a').click(function(e) {
...
/**
 * Show video on Single Project page
 */
  ...
  jQuery('.hasvideo').click(function() {
	...
	if (vidSource.indexOf('?rel=0&autoplay=1') == -1) {
		  ...
		  jQuery('.hasvideo .fluid-width-video-wrapper').show();
		  var styles = {
			paddingTop : "0",
			height: "100%"
		  };
		  jQuery('.hasvideo .fluid-width-video-wrapper').css(styles);
	}
	else {
