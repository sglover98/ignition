...
?>
				...
				<div id="copyright-divider-top"></div>				
					<div class="width-container-pro">
						<div id="copyright-text">
								<?php echo wp_kses(get_theme_mod( 'progression_studios_footer_copyright', 'All Rights Reserved. Developed by IgnitionDeck' ), true); ?>
						</div>
	...
	<a href="#0" id="pro-scroll-top"><?php esc_html_e( 'Scroll to top', 'multifondo-progression' ); ?></a>
